...
<body style="position: fixed;width: 100%;">
   ...
   <h1>QUIZ</h1>
   <div class="row" style="margin-top: -30px;margin-left: 7%">
     <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 " style="color: white;">
       ...
       <h2 style="text-align: -webkit-left;"> <span style="margin-left: -44px;">Q1.</span><span>Onion sells at 20 Rs/ Kg in a nearby market. You have to spend 50 Rs on auto to go there. If you buy 6 Kg of Onion, how much is you total expenditure?</span></h2>
     </div>
   </div>
     <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 " >
       <img src="{{url()}}/images/module2/sample.jpg" width="230px" height="200px" alt="Image" style="margin-left: 0px;margin-top: 4%;">
     </div>
 </div>
  ...
  <div class="concept" align="right" style="margin-right: 30px;" ><button >Go To Concept</button></div>
