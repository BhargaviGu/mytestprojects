...
<body style="position: fixed;width: 100%;">
   ...
   <h1 style="padding-top: 80px">QUIZ</h1>
   <div class="row" style="margin-left: 7%;padding-top: 24px;">
    ...
    <div class="row" style="margin-top: -50px;">
      <div class="col-md-12 col-sm-12" style="color: white;">
        ...
        <img src="{{url()}}/images/module3/helicopter.jpg" width="100px" height="150px" alt="Image" style="border-radius:15px;">
        <p style="padding-top: 0px;"> Helicopter Cost:20,000Rs</p>
        </div>
        <div class="quiz-choice wrong-q1" style="margin-left: 80px;">
        <img src="{{url()}}/images/module3/supercar1.jpg" width="100px" height="150px" alt="Image" style="border-radius:15px;">
        ...
        <div class="quiz-choice wrong-q1" style="margin-left: 80px;">
        <img src="{{url()}}/images/module3/mario.jpg" width="100px" height="150px" alt="Image" style="border-radius:15px;">
  ...
  <div class="concept" align="right" style="padding-right: 12px" ><button >Go To Concept</button></div>
