      ...
      <h1 style="color: white;text-align: center;">Concept</h1>
        <div class="row" style="margin-top: 30px;">
            ...
            <div class="" style="color: white;">
                <h1 style="color: aqua;">Constraints</h1>
            ...
            <div class="">
                <form action="file:///var/www/html/lcs/questions/stockone/blog.html" method="post" style="padding-left: 950px;padding-bottom: 10px;">
