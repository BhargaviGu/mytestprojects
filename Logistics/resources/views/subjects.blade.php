...
<body style="position: fixed;width: 100%;">
				...
				<div class="col-lg-4 col-md-6">
					<div class="blog_items">
						<div class="blog_img_box">
							<img class="img-fluid" src="http://clipart-library.com/images/8ixrGxy4T.jpg" style="width:100%;height:156px;"alt="1">
						</div>
						<div id ="module1"  class="blog_content" style="height: 100px;margin-top: -20px;">
							<a class="title" href="" style="margin-left: 13px;">Mathematics</a><!-- <i style="font-size:24px;padding-left: 205px;" class="fa">&#xf09c;</i> -->
							<br>
 ...
 -->
				...
				<div class="col-lg-4 col-md-6">
					<div class="blog_items">
						<div class="blog_img_box" >
							<img class="img-fluid" src="https://thumbnails-visually.netdna-ssl.com/worldmap-worldmap-photos-wallpapers-galleries-full-hd_50290fb555fd4_w1500.jpg" style="height:156px;" alt="2">
						</div>
						<div id ="module2" class="blog_content" style="height: 100px;margin-top: -20px;">
							<a class="title" href="#" style="margin-left: 13px;">Social Studies</a><!-- <i style="font-size:24px;padding-left: 205px;" class="fa">&#xf023;</i> -->
								<br>
				...
				<div class="col-lg-4 hidden-md"> 
					<div class="blog_items">
						<div class="blog_img_box">
							<img class="iimg-fluid" src="https://thumbs.dreamstime.com/t/economic-chart-growth-background-hd-i-41772402.jpg" style="height:156px;" alt="3">
						</div>
						<div  id ="module3" class="blog_content" style="height: 100px;margin-top: -20px;">
							<a class="title" href="#" style="margin-left: 13px;">Economics</a><!-- <i style="font-size:24px;padding-left: 250px;position: relative;top: -25px;cursor: pointer;" class="fa">&#xf023;</i> -->
