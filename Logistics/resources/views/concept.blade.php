    ...
    <div class="container" style="margin-top: 45px;">
     <h1 style="color: white;text-align: center;">Concept</h1>
        <div class="row" style="margin-top: 40px;">
            ...
            <div class="col-md-8 col-sm-12" style="color: white; font-size:22px;">
                <h1 style="color: aqua;">Speed</h1>
            ...
            <div class="col-md-4 col-sm-12">
                <img src="images/module1/image.jpg" width="300px" height="300px" alt="Concept">
                <br>
                <br>
                <br>
