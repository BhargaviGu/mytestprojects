 ...
 <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
   ...
   padding-top: 5px;">
     ...
     <div class="quiz-choice wrong-q1" style="margin-left: 125px;">
       <img src="{{url()}}/images/module2/ship.jpg" width="100px" height="150px" alt="Image" style="border-radius:15px;">
        <p style="padding-top: 0px;"> Ship Cheaper by 3,500 Rs</p>
     </div>
     <div class="quiz-choice correct-q1">
       <img src="{{url()}}/images/module2/bigcar.jpg" width="100px" height="150px" alt="Image" style="border-radius:15px;">
        <p style="padding-top: 0px;"> Car Cheaper by 3,500 Rs</p>
     </div>
     <div class="quiz-choice wrong-q1">
       <img src="{{url()}}/images/module2/smallcar.jpg" width="100px" height="150px" alt="Image" style="border-radius:15px;">
        <p style="padding-top: 0px;"> Car Cheaper by 16,500 Rs</p>
     </div>
     <div class="quiz-choice wrong-q1">
       <img src="{{url()}}/images/module2/shipAndCar.jpg" width="100px" height="150px" alt="Image" style="border-radius:15px;">
        <p style="padding-top: 0px;"> Both costs the same</p>
     </div>
   </div>
  </div>
  <!-- <div class="col-lg-4" style="padding-top: 180px">
    <img src="lorry.jpg">
  </div> -->
</div>
