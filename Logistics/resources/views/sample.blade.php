...
<body style="position: fixed;width: 100%;">
   ...
   <div class="row" style="margin-top: -30px;margin-left: 10%">
     <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 " style="color: white;">
       ...
       <h2 style="text-align: -webkit-left;"> <span style = "margin-left:-52px;">Q1.</span><span>The Avengers are 3km away from the movie theatre. Their movie starts in 30 minutes. How fast should he ride his bike to reach on time?</span></h2>
     </div>
   </div>
     <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 " >
       <img src="images/module1/img1mod1.jpg" width="230px" height="200px" alt="Image" style="margin-left: 20px;margin-top: 4%;">
     </div>
 </div>
   <div class="row">
