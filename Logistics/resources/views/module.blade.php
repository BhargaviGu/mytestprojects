...
<body style="position: fixed;width: 100%;">
	...
	<header class="header_area">
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light" style="padding: 10px;">
				<div class="container">
					...
					<h2 style="color: white;">Viveka Techno School<span style="margin-left: 500px;color: white;">Ramesh</span></h2>
	...
	<!--================ Start Blog Area ================-->
	<!-- <section class="blog_area" style="background-image: url(https://cdn.pixabay.com/photo/2015/11/07/11/08/truck-1030846_960_720.jpg);background-position: center;
  background-size: cover;min-height: 100%"> -->
  <section class="blog_area" style="margin-top: 20px;" >
		<div class="container"> 
			<div class="row" >
				<div class="col-lg-4 col-md-6">
					<div class="blog_items">
						<div class="blog_img_box">
							<img class="img-fluid" src="https://i.dailymail.co.uk/i/pix/2017/01/18/14/3C3DCE3C00000578-0-South_Korea_wants_to_create_an_ultra_fast_train_it_hopes_will_be-m-72_1484750969074.jpg" style="width:100%;height:156px;"alt="1">
						</div>
						<div id ="module1"  class="blog_content" style="height: 100px;margin-top: -20px;">
							<a class="title" href="" style="margin-left: 13px;">Speed</a><i style="font-size:24px;padding-left: 205px;" class="fa">&#xf09c;</i>
							<!-- <i style="font-size:24px" class="fa">&#xf09c;</i> -->
							<!-- <i class="fa fa-lock" style="font-size:24px;"> -->
							<!-- <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
								dolore magna aliqua. Ut enim ad minim veniam, quis nostrud.</p> -->
							<br>
							
							<div class="rate" style="margin-top: 3px;">
				...
				<div class="col-lg-4 col-md-6">
					<div class="blog_items">
						<div class="blog_img_box" >
							<img class="img-fluid" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTxRlDERNH4sRIWoyYlmx0bTKoS3050zFG1ZqaFyJB5y3LduaYzJA" style="height:156px;" alt="2">
						</div>
						<div id ="module2" class="blog_content" style="height: 100px;margin-top: -20px;">
							<a class="title" href="#" style="margin-left: 13px;">Cost</a><i style="font-size:24px;padding-left: 205px;" class="fa">&#xf023;</i>
							<!-- <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
								dolore magna aliqua. Ut enim ad minim veniam, quis nostrud.</p> -->
								<br>
							<div class="rate" style="margin-top: 0px;">
								<!-- <input type="radio" id="star5" name="rate" value="5" />
						        <label for="star5" title="text">5 stars</label>
							    <input type="radio" id="star4" name="rate" value="4" />
							    <label for="star4" title="text">4 stars</label>
				...
				<div class="col-lg-4 hidden-md"> 
					<div class="blog_items">
						<div class="blog_img_box">
							<img class="iimg-fluid" src="https://d7toastmasters.org/beta/wp-content/uploads/2017/01/Which-Direction.jpg" style="height:156px;" alt="3">
						</div>
						<div  id ="module3" class="blog_content" style="height: 100px;margin-top: -20px;">
							<a class="title" href="#" style="margin-left: 13px;">Constraints</a><i style="font-size:24px;padding-left: 250px;position: relative;top: -25px;cursor: pointer;" class="fa">&#xf023;</i>
							<!-- <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
								dolore magna aliqua. Ut enim ad minim veniam, quis nostrud.</p> -->
								<br>
			...
			<div class="row">
				<div class="col-lg-4 col-md-6">
					<div class="blog_items">
						<div class="blog_img_box">
							<img class="img-fluid" src="https://images.sftcdn.net/images/t_app-cover-l,f_auto/p/1b484204-77d8-4dc3-9a46-b22ebffb1dff/2802405209/american-truck-simulator-special-transport-screenshot.jpg" style="width:100%;height:156px;"alt="4">
						</div>
						<div id ="module4" class="blog_content"style="height: 100px;margin-top: -20px;">
							<a class="title" href="#" style="margin-left: 13px;">Optimization</a><i style="font-size:24px;padding-left: 250px;position: relative;top: -25px" class="fa">&#xf023;</i>
							<br>
							<!-- <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
								dolore magna aliqua. Ut enim ad minim veniam, quis nostrud.</p> -->
							<div class="rate" style="margin-top: -20px;">
				...
				<div class="col-lg-4 col-md-6">
					<div class="blog_items">
						<div class="blog_img_box" >
							<img class="img-fluid" src="https://media.istockphoto.com/photos/gold-us-dollar-symbol-picture-id620368864?k=6&m=620368864&s=612x612&w=0&h=CnANmtCd1n3RCIW2ZPsiir6apjESsGjSclCJgc6JZPc=" style="height:156px;" alt="5">
						</div>
						<div id ="module5" class="blog_content" style="height: 100px;margin-top: -20px;">
							<a class="title" href="#" style="margin-left: 13px;">Demand</a><i style="font-size:24px;padding-left: 250px;position: relative;top: -25px" class="fa">&#xf023;</i>
							<br>
							<!-- <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
								dolore magna aliqua. Ut enim ad minim veniam, quis nostrud.</p> -->
							<div class="rate" style="margin-top: -20px;">
							    ...
							    <label for="star4" title="text">4 stars</label>
							    <input type="radio" id="star3" name="rate" value="3" />
							    <label for="star3" tit150pxle="text">3 stars</label> -->
							    <input type="radio" id="star2" name="rate" value="2" />
							    <label for="star2" title="text">2 stars</label>
							    <input type="radio" id="star1" name="rate" value="1" />
							    <label for="star1" title="text">1 star</label>
				...
				<div class="col-lg-4 hidden-md">
					<div class="blog_items">
						<div class="blog_img_box">
							<img class="img-fluid" src="https://ak4.picdn.net/shutterstock/videos/7379254/thumb/2.jpg" style="height:156px;" alt="6">
						</div>
						<div id ="module6" class="blog_content" style="height: 100px;margin-top: -20px;">
							<a class="title" href="#" style="margin-left: 13px;">Profit</a><i style="font-size:24px;padding-left: 205px;" class="fa">&#xf023;</i>
							<br>
							<!-- <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
								dolore magna aliqua. Ut enim ad minim veniam, quis nostrud.</p> -->
							<div class="rate" style="margin-top: 3px;">
      ...
      <!-- <div class="row" >
        <div class="col-lg-4 col-md-6">
          <div class="blog_items">
            <div class="blog_img_box">
              <img class="img-fluid" src="https://cdn.pixabay.com/photo/2015/11/07/11/08/truck-1030846_960_720.jpg" style="width:100%;height:156px;"alt="1">
            </div>
            <div id ="module1"  class="blog_content" style="height: 100px;margin-top: -20px;">
              <a class="title" href="" style="margin-left: 13px;">Oprtunity Cost</a><i style="font-size:24px;padding-left: 205px;" class="fa">&#xf09c;</i>
              <br>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="blog_items">
            ...
            <div id ="module2" class="blog_content" style="height: 100px;margin-top: -20px;">
              <a class="title" href="" style="margin-left: 13px;">Demand vs Transpot</a><i style="font-size:24px;padding-left: 205px;" class="fa">&#xf023;</i>
                <br>
              <div class="rate" style="margin-top: 0px;">
                  <input type="radio" id="star2" name="rate" value="2" />
                  <label for="star2" title="text">2 stars</label>
        ...
        <div class="col-lg-4 hidden-md"> 
          <div class="blog_items">
            <div class="blog_img_box">
              <img class="img-fluid" src="https://images.sftcdn.net/images/t_app-cover-l,f_auto/p/1b484204-77d8-4dc3-9a46-b22ebffb1dff/2802405209/american-truck-simulator-special-transport-screenshot.jpg" style="height:156px;" alt="3">
            </div>
            <div  id ="module3" class="blog_content" style="height: 100px;margin-top: -20px;">
              <a class="title" href="#" style="margin-left: 13px;">Conversions</a><i style="font-size:24px;padding-left: 205px;" class="fa">&#xf023;</i>
                <br>
              <div class="rate" style="margin-top: -20px;">
                  <input type="radio" id="star2" name="rate" value="2" />
                  <label for="star2" title="text">2 stars</label>
      ...
      <div class="row" >
        <div class="col-lg-4 col-md-6">
          <div class="blog_items">
            ...
            <div id ="module1"  class="blog_content" style="height: 100px;margin-top: -20px;">
              <a class="title" href="" style="margin-left: 13px;">Multiple mode of transport</a><i style="font-size:24px;padding-left: 205px;" class="fa">&#xf09c;</i>
              <br>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="blog_items">
            ...
            <div id ="module2" class="blog_content" style="height: 100px;margin-top: -20px;">
              <a class="title" href="#" style="margin-left: 13px;">Time vs Inventory</a><i style="font-size:24px;padding-left: 205px;" class="fa">&#xf023;</i>
                <br>
              <div class="rate" style="margin-top: -20px;">
                  <input type="radio" id="star2" name="rate" value="2" />
                  <label for="star2" title="text">2 stars</label>
        ...
        <div class="col-lg-4 hidden-md"> 
          <div class="blog_items">
            ...
            <div  id ="module3" class="blog_content" style="height: 100px;margin-top: -20px;">
              <a class="title" href="#" style="margin-left: 13px;">Perishable</a><i style="font-size:24px;padding-left: 205px;" class="fa">&#xf023;</i>
                <br>
              <div class="rate" style="margin-top: -20px;">
                  <input type="radio" id="star2" name="rate" value="2" />
                  <label for="star2" title="text">2 stars</label>
	...
	<!--================Footer Area =================-->
	<!-- <footer class="footer_area" style="margin-top: -120px;">
		<div class="container">
			<div class="row single-footer-widget">
				<div class="col-lg-6 col-md-6 col-sm-12">
					<div class="copy_right_text">
						<p>
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <a href="" target="_blank">Headrun</a></p>
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12">
