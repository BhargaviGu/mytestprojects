...
/*# sourceMappingURL=style.css.map */
    ...
    <div class="container" style="margin-top: 45px;">
      <h1 style="color: white;text-align: center;">Concept</h1>
        <div class="row" style="margin-top: 30px;">
            
            <div class="col-md-8 col-sm-12" style="color: white;">
                <h1 style="color: aqua;">Optimization</h1><p style="font-size: 18px;">For a given objective, one can find best solution in terms of time or money or distance or any external factort.</p>
                <p style="font-size: 18px;"><b>Previous question had an objective as a time constraint (24 hours). Nirav could either fly directly to Mumbai or take a flight to Delhi and then to Mumbai within 24 hours.</b></p>
                <p style="font-size: 18px;"><b>Though direct flight is faster, it doesnt matter since both options could help him reach within stipulated time. However taking flight to Delhi and then to Mumbai is much cheaper, thereby the correct solution.</b></p>
                <p style="font-size: 18px;"><b>Example 1: Cost constraint</b></p>
                <p style="font-size: 18px;">You have only 100 Rs in hand and need to travel for 10 km. You can hire a cab for 20 Rs / km or walk. What would you do to reach at the earliest?</p>
                <p style="font-size: 18px;"><b>Constraint: Money (100 Rs)</b></p>
                <p style="font-size: 18px;">Objective: Travel 10 KM at the earliest.</p>
                <p style="font-size: 18px;"><b>Option 1: Cab
                  <br>Total cost is Number of units * Cost per unit = 10*20 = 200
                  <br>Since Total cost > 100, he cannot take a cab whole distance.
                </b></p>
                <p style="font-size: 18px;">You can walk to your destination. However, this is not the most Optimal solution.
