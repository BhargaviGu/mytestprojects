...
<body>
 ...
 <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
   ...
   padding-top: 5px;">
     <h2 style="text-align:-webkit-left;"><span style="margin-left: -44px;">Q1.</span>You are going to your friends house. You have 3 routes
      ...
      <br>You have to spend 1 Rs per Km for petrol. He has a budget of 25 Rs. 
      <br>Which route will he take to reach at the earliest and how much will he spend?
     </h2>
     <div class="quiz-choice wrong-q1" style="margin-left: 125px;">
       <p style="text-align:center;margin-top: 0px;"> Route 1; 20 Rs</p>
     </div>
     <div class="quiz-choice wrong-q1">
       <p style="text-align:center;margin-top: 0px;"> Route 1; 12 Rs</p>
     </div>
     <div class="quiz-choice correct-q1">
       <p style="text-align:center;margin-top: 0px;"> Route 3; 30 Rs</p>
     </div>
   </div>
  </div>
  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" style="padding-top: 80px">
    <img src="{{url()}}/images/module4/man.jpg">
  </div>
</div>
