...
/*# sourceMappingURL=style.css.map */
    ...
    <h1 style="color: white;text-align: center;">Concept</h1>
        <div class="row" style="margin-top: 40px;">
            ...
            <div class="col-md-8 col-sm-12" style=" font-size: 18px;  color: white;">
                <h1 style="color: aqua;">Total Time and Average Speed</h1>
		...
		<input type="submit" style="font-size: 15px;margin-top: 35px;margin-left: 220px;" id="submit" value="Try Timer Question"> 
