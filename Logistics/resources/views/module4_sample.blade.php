...
/*# sourceMappingURL=bootstrap.min.css.map */
  ...
  <!-- style for hint and show answer -->
  <!-- <style >
...
/*headerrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr area*/
...
.c1{
  ...
  #animation: animate 5s cubic-bezier(.03,-0.63,1,1.73) infinite;
}
#submit{
        height: 50px;
...
He can book a direct flight from London to Mumbai which will take 12 hours for Rs. 50,000. He can also fly from London to Delhi (12 hours) for 25,000 Rs  and another flight from Delhi to Mumbai (4 hours) for 10,000 Rs with a 2 hour stop over in Mumbai. As a third option, after reaching Delhi, he can drive to Mumbai (14 hours) for 5,000 Rs. What is the cheapest mode for Nirav to reach Mumbai within 24 hours and how much time will he take?
    ...
    <div class="row" style="margin-left: 8%; margin-top: -2%;">
     <div class="col-md-12 col-sm-12" style="color: white;">
       ...
       <p style="text-align:center;margin-top: -20px;"> Direct flight to Mumbai ; 12 hours</p>
       </div>
       <div class="quiz-choice wrong-q1">
       <p style="text-align:center;margin-top: -20px;"> Flight to Delhi and Drive to Mumbai ; 24 hours</p>
       </div>
       <div class="quiz-choice correct-q1">
       <p style="text-align:center;margin-top: -20px;"> Flight to Delhi and then fly to Mumbai ; 18 hours</p>
       </div>
       <div class="quiz-choice wrong-q1" style="margin-right: 20px;">
       <p style="text-align:center;margin-top: -20px;"> There is no way to reach in 24 hours</p>
       </div>
     </div>
   </div>
   <div class="concept" align="right" style="padding-right: 12px;position: relative;top: -25px;" ><button >Go To Concept</button></div> 
